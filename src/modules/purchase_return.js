                                            ...
                                            <tr>
                                                ...
                                                <td class="w-50 text-right">
                                                    <address>
                                                        ...
                                                        <p class="text-muted m-l-30">${_filterNull(data.purchase.address)},
                                                        <br> ${_filterNull(data.purchase.email)}</p>
                                                        ...
                                                        <p><b><i class="mdi mdi-animation"></i> Purchase No :</b> <a href="#/purchase/${data.purchase.id}">${_replaceNull(data.purchase.purchase_number)}</a></p>
...
const purchaseReturnController = ((SET, DT, UI) => {
    ...
    const _submitAdd = TOKEN => {
        $('#form_add').validate({
            ...
            submitHandler: form => {
                $.ajax({
                    url: `${SET.apiURL()}supplier_returns`,
                    type: 'POST',
                    dataType: 'JSON',
                    ...
                    success: res => {
                        ...
                        location.hash = `#/supplier_return/${res.results.id}`
                    },
                    error: ({ responseJSON }) => {
