                                    ...
                                    <div class="col-md-8">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" readonly placeholder="[ AUTO ]" value="[ AUTO ]" name="purchase_number" id="purchase_number">
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <tr id="row_0">
                                                        ...
                                                        <td>
                                                            <div class="text-center">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input ppn" value="Y" id="ppn_0" name="ppn[0]" data-id="0">
...
<script type="module">
    ...
    purchaseController.add('<?= $this->session->userdata('api_token') ?>')
</script>