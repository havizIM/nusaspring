<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Add Customer Return</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#/customer_return">Customer Return</a>
                        </li>
...
<script type="module">
    import customerReturnController from '<?= base_url() ?>src/modules/customer_return.js';
    customerReturnController.add('<?= $this->session->userdata('api_token') ?>')
</script>