                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h4 class="m-b-0">Total Customer</h4>
                            <span class="text-muted">Contact</span>
                        </div>
                        <div class="ml-auto align-self-center">
                            <h2 class="font-medium m-b-0" id="count_customer">0</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            ...
                            <span class="text-muted">Receiveable</span>
                        </div>
                        <div class="ml-auto align-self-center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="t_customer" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Phone</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Filter Customer</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="col-4-filter">Receiveable</label>
                        <input type="text" id="col-4-filter" class="form-control filter-data" data-column="4" placeholder="Search Receiveable">
                    </div>
                </div>
...
<script type="module">
    import customerController from '<?= base_url() ?>src/modules/customer.js';
    customerController.data('<?= $this->session->userdata('api_token') ?>')
</script>