const categoryController = ((SET) => {

    const _openDelete = () => {
        $('#t_category').on('click', '.btn-delete', function () {
            let id = $(this).data('id')
    ...
    const _openEdit = () => {
        $('#t_category').on('click', '.btn-edit', function () {
            let id = $(this).data('id')
            let name = $(this).data('name')
                            ...
                            return `
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu animated flipInY" x-placement="bottom-start" style="position: absolute; transform: translate3d(-33px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">
                                        <a class="dropdown-item btn-delete" href="javascript:void(0)" data-id="${row.id}" data-name="${row.category_name}"><i class="fa fa-trash"></i> Delete</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item btn-edit" href="javascript:void(0)" data-id="${row.id}" data-name="${row.category_name}"><i class="fa fa-edit"></i> Edit</a>
                                    </div>
                                </div>
                            `;
                        }
