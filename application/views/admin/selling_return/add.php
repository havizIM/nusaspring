<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Add Selling Return</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#/selling_return">Selling Return</a>
                        </li>
                                    ...
                                    <div class="col-md-8">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" readonly placeholder="[ AUTO ]" value="[ AUTO ]" class="form-control" name="return_number" id="return_number">
                                                </div>
                                                <div class="col-md-6">
...
<script type="module">
    import sellingReturnController from '<?= base_url() ?>src/modules/selling_return.js';
    sellingReturnController.add('<?= $this->session->userdata('api_token') ?>')
</script>