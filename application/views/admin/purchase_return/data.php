                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="ml-auto align-self-center">
                            <h2 class="font-medium m-b-0" id="count_supp_returns">0</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="ml-auto align-self-center">
                            <h2 class="font-medium m-b-0" id="sum_supp_returns">0</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Filter Purchase Return</h4>
...
<form id="form_delete">
    <div id="modal_delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Purchase Return</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
...
<script type="module">
    ...
    purchaseReturnController.data('<?= $this->session->userdata('api_token') ?>')
</script>