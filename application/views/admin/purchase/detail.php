<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Purchase</h4>
        </div>
...
<script type="module">
    import purchaseConntroller from '<?= base_url() ?>src/modules/purchase.js';
    purchaseConntroller.detail('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>